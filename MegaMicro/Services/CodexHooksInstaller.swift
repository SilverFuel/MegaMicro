...
/// report state to MegaMicro's webhook, mirroring the Claude Code installer.
...
/// `#megamicro`, idempotent install.
final class CodexHooksInstaller {
    static let marker = HooksInstaller.marker
    enum InstallError: LocalizedError {
        case malformedHooks
        var errorDescription: String? { "Codex hooks.json is malformed; MegaMicro left it untouched." }
    }
    ...
    var eventStates: [String: String] = AppConfig.defaultCodexHookEvents
